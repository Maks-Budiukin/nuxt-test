<template>
    ...
    <footer id="contacts"
        class="mx-auto w-full lg:w-[1000px] xl:w-[1240px] 2xl:w-[1520px]  px-5 pt-20 md:px-6 pb-5 md:pb-6 lg:pb-12 2xl:pb-20">
        ...
        <div
            class="flex flex-col lg:flex-row items-center justify-center lg:justify-between w-full xl:w-[80%] p-8 sm:p-12 mx-auto gap-8 xl:gap-12 border border-accent rounded-3xl bg-[#272829]">

            <div class="flex flex-col items-center">
                <div class="mb-6">
                    <h3 class="text-white text-4xl sm:text-7xl lg:text-5xl xl:text-5xl 2xl:text-7xl">Like my <span
                            class="text-accent">works</span>?
                    </h3>
                </div>
                ...
                <div>
                    <div class="mb-10">
                        <p class="text-white text-xl sm:text-3xl lg:text-xl xl:text-2xl 2xl:text-3xl">
                            &#8213;
                            <span class="text-accent">Contact</span> me via:
                        </p>
                    </div>
                    ...
                    <div class="flex flex-col gap-3">
                        <div>
                            <NuxtLink to="https://t.me/bud_maks" target="_blank"
                                class="flex gap-3 items-center text-white text-lg hover:text-accent stroke-[#FFFFFF] hover:stroke-accent duration-300">
                                <div>
                        ...
                        <div>
                            <NuxtLink to="mailto:maks.budyukin@gmail.com" target="_blank"
                                class="flex gap-3 items-center text-white text-lg hover:text-accent fill-[#FFFFFF] hover:fill-accent duration-300">
                                <div>
                                    <IconsEmail size="32" />
                                </div>
                                <div>
            ...
            <div class="w-full lg:w-[50%]">
                <div class="mb-6">
                    <p
                        ...
                        &#8213; Leave me
                        a <span class="text-accent">message</span>:</p>
                </div>
                <form id="messageForm" @submit.prevent="handleFormSubmit" class="flex flex-col gap-3">
                    <div class="flex flex-col gap-2 text-white focus-within:text-accent duration-300">
                        <label :for="nameId">Your name</label>
                        <input v-model="name" :id="nameId" type="text" autocomplete="on" required
                            class=" text-white text-xl bg-[#3D3E42] rounded outline-none hover:outline-accent duration-300 p-3 focus:ring focus:ring-accent">
                    </div>
                    ...
                    <div class="flex flex-col gap-2 text-white focus-within:text-accent duration-300">
                        ...
                        <textarea v-model="message" :id="messageId" rows="3" autocomplete="on"
                            class=" text-white text-xl bg-[#3D3E42] rounded outline-none hover:outline-accent duration-300 p-3 focus:ring focus:ring-accent resize-none"></textarea>
                    </div>
