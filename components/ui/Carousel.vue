  ...
  <div class="h-full w-full">
    <div v-show="!open" class="h-full w-full">
            ...
            <Transition :name="transitionName" mode="out-in">
              <KeepAlive>
                <NuxtImg
                  ...
                  :key="currentImage"
                  @load="imageLoading"
                  :src="`https://test-strapi-mrqj.onrender.com${currentImage}`"
                  alt="Project picture"
                  class="w-full sm:rounded-lg cursor-pointer big-image"
      ...
      <div
        ...
        class="hidden sm:flex items-center min-h-[148px] relative px-12"
      >
            ...
            <div
              ...
              :class="
                idx === currentImageIndex
                  ? 'border-[#F0BF6C] min-w-[220px]'
                  : 'border-transparent'
              "
            >
              <NuxtImg
                :src="`https://test-strapi-mrqj.onrender.com${image}`"
                sizes="sm:120px"
                alt=""
    ...
    <LazyUiCarouselModal
      ...
      @close="open = false"
      :images="images"
      :currentImage="`https://test-strapi-mrqj.onrender.com${currentFullImage}`"
